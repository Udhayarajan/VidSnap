...
public class Statics {
    public static final String PACKAGE_NAME = "com.mugames.vidsnap";
    public static final String TAG = "MUTube";
    public static final String PROGRESS = "progress";
    public static final String TOTAL_SIZE = "filesize";
    public static final String DOWNLOADED = "completed";
