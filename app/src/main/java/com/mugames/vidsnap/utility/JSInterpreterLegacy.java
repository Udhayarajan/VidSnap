...
public class JSInterpreterLegacy {
    ...
    public JSInterpreterLegacy(String code, Hashtable<String,Hashtable<String, JSInterface>> objects) {
        this.code = code;
        ...
        if(m.find()&& m.matches()){
            ...
            if(arg_str.isEmpty()){
                ...
                for (String v : arg_str.split(",")){
                    arg_val.add(interpretExpression(v,recurLimit));
                }
            }
